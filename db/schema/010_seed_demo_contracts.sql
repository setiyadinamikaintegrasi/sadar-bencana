...
-- ─── JAKARTA CLUSTER (~16 rows) ─────────────────────────────────────────────
    ...
    ('FAC-2026-0016','PT Reasuransi Nasional','Hotel Mulia Senayan','Jl. Asia Afrika, Jakarta Pusat','earthquake','facultative','hotel',
...
-- ─── SURABAYA CLUSTER (~10 rows) ────────────────────────────────────────────
    ...
    ('FAC-2026-0025','PT Reasuransi Nasional','Hotel Bumi Surabaya','Jl. Jend. Basuki Rahmat, Surabaya','earthquake','facultative','hotel',
    ...
    ('FAC-2026-0031','PT Reasuransi Nasional','Gedung BNI Surabaya','Jl. Pemuda, Surabaya','earthquake','facultative','office_highrise',
...
-- ─── BANDUNG CLUSTER (~8 rows) ──────────────────────────────────────────────
    ...
    ('FAC-2026-0035','PT Reasuransi Nasional','Hotel Savoy Homann','Jl. Asia Afrika, Bandung','earthquake','facultative','hotel',
...
-- ─── MEDAN CLUSTER (~7 rows) ────────────────────────────────────────────────
    ...
    ('TRT-2026-0040','PT Reasuransi Nasional','Pelabuhan Belawan','Medan Utara','flood','treaty','port',
...
-- ─── PADANG / WEST SUMATRA SEISMIC CLUSTER (~4 rows) ────────────────────────
    ...
    ('TRT-2026-0050','PT Reasuransi Nasional','Kawasan Industri Padang','Padang, Sumatera Barat','earthquake','treaty','industrial',
