"""Generate reinsurance briefings using local LLM (Gemma4-E4B via llama.cpp).
...
_SYSTEM_PROMPT = (
    "Anda adalah asisten analisis risiko reasuransi untuk PT Tugure. "
    ...
    "paling terdampak, dan rekomendasi tindak lanjut untuk tim underwriting. "
...
def _fallback_summary(events: list[EarthquakeEvent]) -> str:
    ...
    return (
        ...
        f"Rekomendasi: verifikasi eksposur portofolio dan akumulasi treaty pada area terdampak. "
...
async def generate_briefing(events: list[EarthquakeEvent]) -> str:
    ...
    user_prompt = (
        ...
        "Buat ringkasan briefing risiko reasuransi."
    )
